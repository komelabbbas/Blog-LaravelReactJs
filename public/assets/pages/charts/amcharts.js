var AMCharts = function () {
    ...
    var handleStackAreaChart = function () {
        var stackAreaChart = AmCharts.makeChart("stack-area-chart", {
            ...
            "graphs": [{
                "balloonText": "" +
                "<img src='../../assets/global/img/charts/car.png' style='vertical-align:bottom; " +
                ...
                "balloonText": "" +
                "<img src='../../assets/global/img/charts/motorcycle.png' style='vertical-align:bottom;" +
                " margin-right: 10px; width:28px; height:21px;'><span style='font-size:14px; color:#000000;'>" +
                "<b>[[value]]</b></span>",
                "fillAlphas": 0.6,
                "lineAlpha": 0.4,
                ...
                "balloonText": "" +
                "<img src='../../assets/global/img/charts/bicycle.png' style='vertical-align:bottom; " +
                "margin-right: 10px; width:28px; height:21px;'><span style='font-size:14px; color:#000000;'>" +
                "<b>[[value]]</b></span>",
                "fillAlphas": 0.6,
                "lineAlpha": 0.4,
