<header class="site-header">
    <a href="#" class="brand-main">
        <img src="{{ asset('assets/global/img/logo-desk.png') }}" id="logo-desk" alt="Laraspace Logo" class="hidden-sm-down">
        <img src="{{ asset('assets/global/img/logo-mobile.png') }}" id="logo-mobile" alt="Laraspace Logo" class="hidden-md-up">
    </a>
    ...
    <ul class="action-list">
        ...
        <li>
            <a href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="avatar"><img
                    src="{{ asset('assets/global/img/avatars/avatar.png') }}" alt="Avatar"></a>
            <div class="dropdown-menu dropdown-menu-right notification-dropdown">
